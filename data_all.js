const lessonReview40 = [
  // ===== 导数（8天，Day1-8，选必二） =====
  { day:1, date:"2026-07-24", topic:"导数的概念与几何意义", content:["极限思想引入导数定义", "切线方程与瞬时变化率", "导数几何意义的应用"], difficulty:"基础", reference:"全品一轮 P.102 · 选必二" },
  { day:2, date:"2026-07-25", topic:"导数的运算法则", content:["基本初等函数求导公式", "和差积商求导法则", "复合函数求导初步"], difficulty:"基础", reference:"全品一轮 P.105 · 选必二" },
  { day:3, date:"2026-07-26", topic:"复合函数与隐函数求导", content:["复合函数链式法则", "隐函数求导方法", "求导中的易错点辨析"], difficulty:"中档", reference:"全品一轮 P.108 · 选必二" },
  { day:4, date:"2026-07-27", topic:"导数与函数单调性", content:["利用导数判断单调区间", "含参数单调性分类讨论", "单调性逆向问题"], difficulty:"中档", reference:"全品一轮 P.112 · 选必二" },
  { day:5, date:"2026-07-28", topic:"导数与极值、最值", content:["极值点的判定方法", "闭区间最值求解", "极值与最值的区别联系"], difficulty:"中档", reference:"全品一轮 P.116 · 选必二" },
  { day:6, date:"2026-07-29", topic:"含参数的函数最值与范围", content:["参变分离法求参数范围", "分类讨论策略", "恒成立与存在性问题"], difficulty:"综合", reference:"全品一轮 P.120 · 选必二" },
  { day:7, date:"2026-07-30", topic:"导数与不等式证明", content:["构造函数证明不等式", "放缩法与导数结合", "洛必达法则初步应用"], difficulty:"综合", reference:"全品一轮 P.124 · 选必二" },
  { day:8, date:"2026-07-31", topic:"导数综合应用与零点问题", content:["函数零点个数判断", "隐零点问题处理", "导数大题综合训练"], difficulty:"综合", reference:"全品一轮 · 两版对照" },

  // ===== 三角函数（6天，Day9-14） =====
  { day:9, date:"2026-08-01", topic:"任意角与弧度制", content:["象限角与终边相同角", "弧度制与角度制互化", "扇形面积与弧长公式"], difficulty:"基础", reference:"全品一轮 P.56" },
  { day:10, date:"2026-08-02", topic:"三角函数定义与同角关系", content:["单位圆定义三角函数", "同角三角函数基本关系", "诱导公式推导与应用"], difficulty:"基础", reference:"全品一轮 P.59" },
  { day:11, date:"2026-08-03", topic:"三角函数图象与性质", content:["正弦余弦正切函数图象", "周期性与奇偶性", "单调区间与值域"], difficulty:"中档", reference:"全品一轮 P.63" },
  { day:12, date:"2026-08-04", topic:"y=Asin(ωx+φ)图象变换", content:["振幅/周期/相位变换", "由图象求解析式", "图象变换的综合应用"], difficulty:"中档", reference:"全品一轮 P.67" },
  { day:13, date:"2026-08-05", topic:"两角和差与二倍角公式", content:["两角和差公式推导", "二倍角与半角公式", "辅助角公式应用"], difficulty:"中档", reference:"全品一轮 P.71" },
  { day:14, date:"2026-08-06", topic:"三角恒等变换综合", content:["三角化简求值技巧", "条件等式证明", "三角函数综合大题训练"], difficulty:"综合", reference:"全品一轮 · 两版对照" },

  // ===== 数列（6天，Day15-20，选必二） =====
  { day:15, date:"2026-08-07", topic:"数列概念与等差数列", content:["数列通项与前n项和", "等差数列性质与应用", "等差数列基本量计算"], difficulty:"基础", reference:"全品一轮 P.86 · 选必二" },
  { day:16, date:"2026-08-08", topic:"等比数列", content:["等比数列定义与通项", "等比数列性质", "等差等比综合判断"], difficulty:"基础", reference:"全品一轮 P.90 · 选必二" },
  { day:17, date:"2026-08-09", topic:"数列求和（分组/裂项/错位）", content:["分组求和与并项求和", "裂项相消法", "错位相减法"], difficulty:"中档", reference:"全品一轮 P.94 · 选必二" },
  { day:18, date:"2026-08-10", topic:"数列通项公式求法", content:["累加法与累乘法", "构造法求通项", "已知Sn求an"], difficulty:"中档", reference:"全品一轮 P.97 · 选必二" },
  { day:19, date:"2026-08-11", topic:"数列与不等式综合", content:["数列不等式证明", "放缩法在数列中的应用", "数列中的存在性问题"], difficulty:"综合", reference:"全品一轮 P.100 · 选必二" },
  { day:20, date:"2026-08-12", topic:"数列综合训练", content:["数列与函数交汇问题", "数列实际应用题", "数列大题限时训练"], difficulty:"综合", reference:"全品一轮 · 两版对照" },

  // ===== 平面向量（5天，Day21-25） =====
  { day:21, date:"2026-08-13", topic:"平面向量的概念与线性运算", content:["向量定义与几何表示", "向量加减法与数乘", "共线向量定理及应用"], difficulty:"基础", reference:"全品一轮 P.108" },
  { day:22, date:"2026-08-14", topic:"平面向量基本定理与坐标表示", content:["平面向量基本定理", "向量坐标运算", "共线条件的坐标表示"], difficulty:"基础", reference:"全品一轮 P.112" },
  { day:23, date:"2026-08-15", topic:"平面向量的数量积", content:["数量积定义与性质", "数量积的坐标运算", "向量的夹角与模长"], difficulty:"中档", reference:"全品一轮 P.116" },
  { day:24, date:"2026-08-16", topic:"平面向量在几何中的应用", content:["向量法证明平行与垂直", "向量法求长度与角度", "向量与三角结合问题"], difficulty:"中档", reference:"全品一轮 P.120" },
  { day:25, date:"2026-08-17", topic:"平面向量综合训练", content:["向量与解析几何结合", "向量中的最值与范围问题", "平面向量综合大题训练"], difficulty:"综合", reference:"全品一轮 · 两版对照" },

  // ===== 立体几何（6天，Day26-31） =====
  { day:26, date:"2026-08-18", topic:"空间几何体三视图与表面积", content:["三视图还原直观图", "柱锥台球表面积计算", "展开图与最短路径"], difficulty:"基础", reference:"全品一轮 P.130" },
  { day:27, date:"2026-08-19", topic:"空间几何体体积", content:["柱锥台球体积公式", "割补法求体积", "等体积法应用"], difficulty:"基础", reference:"全品一轮 P.134" },
  { day:28, date:"2026-08-20", topic:"空间点线面位置关系", content:["四个公理及推论", "线面平行判定与性质", "面面平行判定与性质"], difficulty:"中档", reference:"全品一轮 P.138" },
  { day:29, date:"2026-08-21", topic:"线面垂直与面面垂直", content:["线面垂直判定定理", "面面垂直判定与性质", "线面角与二面角概念"], difficulty:"中档", reference:"全品一轮 P.142" },
  { day:30, date:"2026-08-22", topic:"空间中的距离与翻折问题", content:["点到面的距离求法", "异面直线距离", "翻折与展开问题"], difficulty:"中档", reference:"全品一轮 P.146" },
  { day:31, date:"2026-08-23", topic:"立体几何综合训练（几何法）", content:["几何法证明平行与垂直", "几何法求空间角", "立体几何大题限时训练"], difficulty:"综合", reference:"全品一轮 · 两版对照" },

  // ===== 空间向量（4天，Day32-35，选必一） =====
  { day:32, date:"2026-08-24", topic:"空间向量及其运算", content:["空间向量加减与数乘", "数量积与夹角", "空间向量基本定理"], difficulty:"基础", reference:"全品一轮 P.150 · 选必一" },
  { day:33, date:"2026-08-25", topic:"空间直角坐标系与向量坐标", content:["建系与点的坐标", "向量坐标运算", "法向量的求法"], difficulty:"基础", reference:"全品一轮 P.153 · 选必一" },
  { day:34, date:"2026-08-26", topic:"用空间向量求空间角", content:["线线角与线面角求法", "二面角的向量求法", "空间角综合应用"], difficulty:"中档", reference:"全品一轮 P.156 · 选必一" },
  { day:35, date:"2026-08-27", topic:"空间向量综合与距离问题", content:["点到面的距离向量求法", "空间向量法解综合大题", "几何法与向量法对比"], difficulty:"综合", reference:"全品一轮 · 两版对照" },

  // ===== 解析几何（5天，Day36-40） =====
  { day:36, date:"2026-08-28", topic:"直线方程与两直线位置关系", content:["直线方程五种形式", "点到直线距离公式", "两直线平行与垂直条件"], difficulty:"基础", reference:"全品一轮 P.160" },
  { day:37, date:"2026-08-29", topic:"圆的方程与直线与圆", content:["圆的标准与一般方程", "直线与圆的位置关系", "弦长公式与切线问题"], difficulty:"基础", reference:"全品一轮 P.164" },
  { day:38, date:"2026-08-30", topic:"椭圆、双曲线、抛物线定义与方程", content:["三种曲线定义与标准方程", "待定系数法求方程", "圆锥曲线定义的应用"], difficulty:"中档", reference:"全品一轮 P.168 · 选必一" },
  { day:39, date:"2026-08-31", topic:"圆锥曲线几何性质与直线位置关系", content:["离心率与渐近线", "联立方程与韦达定理", "弦长与面积问题"], difficulty:"综合", reference:"全品一轮 P.172 · 选必一" },
  { day:40, date:"2026-09-01", topic:"解析几何综合与阶段检测", content:["定点定值与存在性问题", "圆锥曲线最值与范围", "一轮复习全模块综合检测"], difficulty:"综合", reference:"全品一轮 · 两版对照" },
];

const lessonSummer20 = [
  // ===== 椭圆（5天，Day1-5，选必一） =====
  { day:1, date:"2026-07-24", topic:"椭圆的定义", content:["椭圆定义的两种形式", "定义法求轨迹方程", "焦点三角形面积公式"], difficulty:"基础", reference:"选必一 P.38 · 新课标A版" },
  { day:2, date:"2026-07-25", topic:"椭圆的标准方程", content:["标准方程的推导", "待定系数法求方程", "a,b,c关系与方程辨析"], difficulty:"基础", reference:"选必一 P.42 · 新课标A版" },
  { day:3, date:"2026-07-26", topic:"椭圆的几何性质", content:["范围/对称性/顶点/离心率", "焦点弦与通径", "性质综合应用"], difficulty:"中档", reference:"选必一 P.46 · 新课标A版" },
  { day:4, date:"2026-07-27", topic:"直线与椭圆的位置关系", content:["联立方程与判别式", "弦长公式与中点弦", "面积问题的处理策略"], difficulty:"中档", reference:"选必一 P.51 · 新课标A版" },
  { day:5, date:"2026-07-28", topic:"椭圆焦点弦与综合问题", content:["焦点弦性质与弦长", "椭圆中的定点定值", "椭圆综合大题训练"], difficulty:"综合", reference:"选必一 P.55 · 新课标A版" },

  // ===== 双曲线（4天，Day6-9，选必一） =====
  { day:6, date:"2026-07-29", topic:"双曲线的定义与标准方程", content:["双曲线定义与椭圆对比", "标准方程的求法", "等轴双曲线与共轭双曲线"], difficulty:"基础", reference:"选必一 P.59 · 新课标A版" },
  { day:7, date:"2026-07-30", topic:"双曲线的几何性质", content:["渐近线方程与离心率", "焦点到渐近线距离", "双曲线性质综合应用"], difficulty:"中档", reference:"选必一 P.63 · 新课标A版" },
  { day:8, date:"2026-07-31", topic:"直线与双曲线的位置关系", content:["联立方程与交点个数", "弦长与中点问题", "双曲线中的特殊位置关系"], difficulty:"中档", reference:"选必一 P.67 · 新课标A版" },
  { day:9, date:"2026-08-01", topic:"双曲线综合训练", content:["双曲线与椭圆对比辨析", "双曲线轨迹方程", "双曲线大题限时训练"], difficulty:"综合", reference:"选必一 P.70 · 新课标A版" },

  // ===== 抛物线（4天，Day10-13，选必一） =====
  { day:10, date:"2026-08-02", topic:"抛物线的定义与标准方程", content:["抛物线定义与焦点准线", "四种标准方程形式", "定义法求轨迹方程"], difficulty:"基础", reference:"选必一 P.74 · 新课标A版" },
  { day:11, date:"2026-08-03", topic:"抛物线的几何性质", content:["通径与焦点弦长", "抛物线范围与对称性", "性质综合应用"], difficulty:"中档", reference:"选必一 P.78 · 新课标A版" },
  { day:12, date:"2026-08-04", topic:"直线与抛物线的位置关系", content:["联立方程与判别式", "弦长与中点弦问题", "焦点弦性质灵活应用"], difficulty:"中档", reference:"选必一 P.82 · 新课标A版" },
  { day:13, date:"2026-08-05", topic:"抛物线综合训练", content:["抛物线中的定点定值", "抛物线与圆结合", "抛物线大题限时训练"], difficulty:"综合", reference:"选必一 P.85 · 新课标A版" },

  // ===== 导数（6天，Day14-19，选必二） =====
  { day:14, date:"2026-08-06", topic:"导数的概念与几何意义", content:["极限思想引入导数定义", "切线方程与瞬时变化率", "导数几何意义的应用"], difficulty:"基础", reference:"选必二 P.80 · 新课标A版" },
  { day:15, date:"2026-08-07", topic:"导数的运算法则", content:["基本初等函数求导公式", "和差积商求导法则", "复合函数求导初步"], difficulty:"基础", reference:"选必二 P.85 · 新课标A版" },
  { day:16, date:"2026-08-08", topic:"复合函数与隐函数求导", content:["复合函数链式法则", "隐函数求导方法", "求导中的易错点辨析"], difficulty:"中档", reference:"选必二 P.88 · 新课标A版" },
  { day:17, date:"2026-08-09", topic:"导数与函数单调性", content:["利用导数判断单调区间", "含参数单调性分类讨论", "单调性逆向问题"], difficulty:"中档", reference:"选必二 P.92 · 新课标A版" },
  { day:18, date:"2026-08-10", topic:"导数与极值、最值", content:["极值点的判定方法", "闭区间最值求解", "含参数的最值问题"], difficulty:"中档", reference:"选必二 P.96 · 新课标A版" },
  { day:19, date:"2026-08-11", topic:"导数综合应用与零点问题", content:["构造函数证明不等式", "函数零点个数判断", "导数大题综合训练"], difficulty:"综合", reference:"选必二 P.100 · 新课标A版" },

  // ===== 数列（6天，Day20-25，选必二） =====
  { day:20, date:"2026-08-12", topic:"数列概念与等差数列", content:["数列通项与前n项和", "等差数列性质与应用", "等差数列基本量计算"], difficulty:"基础", reference:"选必二 P.5 · 新课标A版" },
  { day:21, date:"2026-08-13", topic:"等比数列", content:["等比数列定义与通项", "等比数列性质", "等差等比综合判断"], difficulty:"基础", reference:"选必二 P.12 · 新课标A版" },
  { day:22, date:"2026-08-14", topic:"数列求和（分组/裂项/错位）", content:["分组求和与并项求和", "裂项相消法", "错位相减法"], difficulty:"中档", reference:"选必二 P.20 · 新课标A版" },
  { day:23, date:"2026-08-15", topic:"数列通项公式求法", content:["累加法与累乘法", "构造法求通项", "已知Sn求an"], difficulty:"中档", reference:"选必二 P.28 · 新课标A版" },
  { day:24, date:"2026-08-16", topic:"数列与不等式综合", content:["数列不等式证明", "放缩法在数列中的应用", "数列中的存在性问题"], difficulty:"综合", reference:"选必二 P.32 · 新课标A版" },
  { day:25, date:"2026-08-17", topic:"数列综合训练", content:["数列与函数交汇问题", "数列实际应用题", "数列大题限时训练"], difficulty:"综合", reference:"选必二 P.35 · 新课标A版" },
];
